...
class AddStudentExcutive extends StatefulWidget {
  @override
  _AddStudentExcutiveState createState() => _AddStudentExcutiveState();
}

class _AddStudentExcutiveState extends State<AddStudentExcutive> {
...
final picker = ImagePicker();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Add Student Excutives"),
      ),
  ...
  Widget _bottomUpload(BuildContext context) {
    void upload() async {
      ...
      DocumentReference documentReference =
          FirebaseFirestore.instance.collection("Student_Executive").doc();
